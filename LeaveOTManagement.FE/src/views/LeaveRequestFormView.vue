    ...
    <div class="card-body p-4">
      <form @submit.prevent="submitLeave">
        ...
        <div class="mb-4">
          ...
          <textarea class="form-control" rows="3" v-model="reason" placeholder="Example: Family vacation..."
            required></textarea>
        </div>
...
const submitLeave = async () => {
  ...
  try {
    ...
    window.$toast(response.data.message || "Leave request submitted successfully", "success")
