    ...
    <main>
      ...
      <div class="ot-grid">
        ...
        <div v-for="ot in paginatedOT" :key="ot.id" class="ot-card" @click="openDetail(ot)">
          ...
          <div class="card-status-strip" :class="ot.status?.toLowerCase()">
          </div>
        ...
        <div v-if="selectedOT" class="modal-overlay" @click.self="selectedOT = null">
          ...
          <div class="modal-card">
            ...
            <div class="timeline">
              ...
              <div class="timeline-item" :class="{ done: selectedOT.status === 'HRApproved' }">
                <div class="dot"></div>
                HR Decision
              </div>
            ...
            <div v-if="selectedOT.status === 'Pending'" class="modal-actions">
